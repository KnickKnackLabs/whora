...
The current suite has **62 tests** (**17 BATS** + **45 pytest**). `mise run test` runs BATS, Python unit tests, and ruff lint/format checks. The repo also has **9 convention lints** configured.
